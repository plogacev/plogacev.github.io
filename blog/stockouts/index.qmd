...
date: 2025-07-14
categories: [bayesian, hmm, time-series, inventory]
...
# Compile the custom Stan model (force_recompile so the binary is always
# built for the current platform, rather than reusing a committed one).
model <- cmdstan_model("./stockouts_v1.stan", force_recompile = TRUE)
